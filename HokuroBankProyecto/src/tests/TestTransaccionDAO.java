...
public class TestTransaccionDAO {
	...
	public static void main(String[] args) throws IOException {
		...
		assert transaccionDAO.QueryByIdCuenta(transaccionTest.getIdCuentaOrigen()).size() == 1 : "Error numero de transacciones de cuenta bancaria origen";
		
		assert transaccionDAO.QueryByIdCuenta(transaccionTest.getIdCuentaDestino()).size() == 1 : "Error numero de transacciones de cuenta bancaria destino";
