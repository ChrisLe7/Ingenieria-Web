   ...
   <div class="container-fluid">
      ...
      <nav class="navbar navbar-fixed-top navbar-default bottom">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#header">Hokuro Bank</a>
          </div><!-- /.navbar-header -->
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="slider-content">
                      <h1></h1>
                      <p>La compañía bancaria con mayor seguridad del Espacio Económico Europeo</p>
                       <br></br>
        ...
        var dataHeader = [
                            {
                              ...
                              title : "Fácil y segura",
							  author : "Hokuro Inc."
                            },
                            {
                              bigImage :"images/slide-2.jpg",
                              title : "Sin comisiones de administración",
                              author : "Hokuro Inc."
                            },
                            {
    ...
    <section id="about" class="light">
      <header class="title">
        ...
        <p>Más de 700.000 clientes disfrutan ya de una Cuenta Online completamente <strong>segura</strong> sin comisiones ni condiciones.</p>
      </header>
    ...
    <section id="team" class="light">
      <header class="title">
        ...
        <p>Somos un equipo de trabajo que lleva varios años trabajando juntos, y se han juntado para realizar varios proyectos, entre ellos, Hokuro Bank. Aquí podréis encontrar un poco de información de cada uno de los integrantes.</p>
      </header>
